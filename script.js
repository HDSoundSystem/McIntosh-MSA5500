...
// Fermer la popup
closeSpeed?.addEventListener('click', () => {
...
speedSlider?.addEventListener('input', (e) => {
    ...
    // Application sur l'élément audio HTML5
    if (audio) {
    ...
    if (speedValueDisplay) {
        speedValueDisplay.innerText = `SPEED: ${val.toFixed(2)}x`;
    }
    
    // Affichage bref sur le VFD
    showStatusBriefly(`SPEED: ${val.toFixed(2)}x`);
});
